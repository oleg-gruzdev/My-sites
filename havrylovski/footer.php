...
<g>
	...
	<path class="st0" d="M134.8,126.4c0,0-3.3,4.7-7.3,6.3c-4,1.6-6.1-6.7-5.8-14c0.4-7.5,4.9-16.5,13.3-19.7c8.4-3.1,14.4-1,14.4-1
		...
		L147.6,103.9L147.6,103.9z"/>
			...
			<!--<img src="<?php bloginfo('template_directory') ?>/images/logo-footer.svg" style='width: 230px; height: 115px' alt="logotyp">-->
			<span class="copyright">Havrylovski, 2017. All rights reserved</span>
		</div> 
	</footer><!-- #colophon -->
</div><!-- #page -->
