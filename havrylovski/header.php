...
<div id="page" class="site wrapper">
	...
	<div class="header group">
		<div class="container-fluid">
			<div class="burger">
					<div class="serif serif--1"></div>
					<div class="serif serif--2"></div>
					<div class="serif serif--3"></div>
			</div>
			

<?  $home_page = new WP_Query ( array ( 'post_type' => 'page',
										'page_id' => 8,
										) 
									);
...
<style type="text/css">
	...
	svg>g {
		display: block;
		transform: scale(1.789) translateX(-117px) translateY(-45px);
	}
</style>
<g>
	<g>
	...
	<path class="st0" d="M134.8,126.4c0,0-3.3,4.7-7.3,6.3c-4,1.6-6.1-6.7-5.8-14c0.4-7.5,4.9-16.5,13.3-19.7c8.4-3.1,14.4-1,14.4-1
		...
		L147.6,103.9L147.6,103.9z"/>
				...
				<?php wp_nav_menu( array( 'theme_location' => 'menu', 'container' => 'false', 'menu_class' => 'header-nav' ) ); ?>

				
			<!--MOBILE MENU IN HEADER-->
			<?php wp_nav_menu( array( 'theme_location' => 'mobile_menu', 'container' => 'nav', 'container_class' => 'mobile-nav', 'menu_class' => 'mobile-nav-list' ) ); ?>
			
			<!--MOBILE MENU IN HEADER END-->
